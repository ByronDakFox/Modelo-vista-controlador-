                ...
                <table class="table table-success table-striped table table-bordered" border="2">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" nowrap style="text-align:center">Materias</th>
                            <th scope="col" nowrap style="text-align:center">Descripción</th>
                    ...
                    <tbody>
                        <?php 
                        $count=1;
                        foreach($this->MODEL->selectMaterias() as $e){
                            $listaM=$e->clas_id."||".$e->clas_nombre."||".$e->clas_descripcion;
                            echo "<tr>";
                            echo"<td style='text-align:center'>".$count."</td>";
                            echo"<td style='text-align:center'>".$e->clas_nombre."</td>";
                            echo"<td style='text-align:center'>".$e->clas_descripcion."</td>";
                            
                            ?>
                        <td nowrap style="text-align:center"> <a class="btn btn-outline-danger"
                                href="?c=eliminarM&id=<?php echo $e->clas_id; ?>" title="Editar informacion"
                        ...
                        <td nowrap style="text-align:center"> <a class="btn btn-outline-info" data-bs-toggle="modal"
                                ...
                                onclick="obtenerDatos2('<?php echo $listaM ?>')"><img
                        ...
                        <div class="modal-content">
                            ...
                            <div id="bmodal" class="modal-body">
                                <div class="form-row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control" id="txtMater" name="txtMater">
                                    </div>
                                    <div class="col-sm-6">
                                        <label><b>Descripción:</b></label>
                                        <textarea type="text" rows="5" cols="20" class="form-control" id="txtDescr"
                                            name="txtDescr"></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-outline-primary"
                                    onclick="actualizarMateria()">Guardar</button>
                            </div>
                        </div>
                    </div>
                </div>
