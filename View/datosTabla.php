        ...
        <section class="breadcrumbs">
            <div class="container">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h2>Información Estudiantes</h2>
                    <ol>
                        <li><a href="?c=informacion">Información</a></li>
                        <li>Datos estudiantes</li>
                    </ol>
                </div>
                ...
                <table class="table table-success table-striped table table-bordered" border="2">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" nowrap style="text-align:center">Materia</th>
                            <th scope="col" nowrap style="text-align:center">Descripción</th>
                            <th scope="col" nowrap style="text-align:center">Jornada</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php 
                        $count=1;
                        foreach($this->MODEL->selectInformacion() as $x){
                            echo "<tr>";
                            ...
                            echo"<td style='text-align:center'>".$x->clas_nombre."</td>";
                            echo"<td style='text-align:center'>".$x->clas_descripcion."</td>";
                            echo"<td style='text-align:center'>".$x->jor_tipo."</td>";
                            echo "</tr>";
                            $count++;
                        }
                        ?>
